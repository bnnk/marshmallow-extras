...
marshmallow-extras is a python package which helps in serialization of hevay and hardcore objects easily using marshmallow (cause this is a plugin for marshmallow)
